        ...
        <div>
            <table>
                <tr>
                 ...
                 <tr>
                    <td>סיסמה: </td>
                    <td><input type ="password" id="password" name="password" /></td> <td style="color:red"><%Response.Write(PassError); %> </td> 
                </tr>
                <tr>
                    <td>אימות סיסמה: </td>
                 ...
                 <tr>
                    <td>מייל: </td>
                    <td><input type ="text" id="email" name="email" value="<%Response.Write(Email); %>" /></td> <td style="color:red"> <%Response.Write(EmailError); %> </td>
                </tr>
                <tr>
                    <td>מין: </td>
            ...
            <p style ="font-style:oblique; color:black">  <%Response.Write(DateOfBirth); %></p>
